                ...
                <Card>
                    <FormsField variant="file" align="flex-end">
                        <FormsField>
                            <Input
                                ...
                                Razão social
                                {errors.razaoSocial && (
                                    <span style={{ color: "red", fontSize: "1rem", paddingLeft: "21rem" }}>{errors.razaoSocial}</span>
                                )}
                            </Input>
                            <Input
                                id="nomeFantasia"
                                ...
                                Nome fantasia
                                {errors.nomeFantasia && (
                                    <span style={{ color: "red", fontSize: "1rem", paddingLeft: "20rem" }}>{errors.nomeFantasia}</span>
                                )}
                            </Input>
                        </FormsField>
                    ...
                    <FormsField variant="double">
                        <Input
                            ...
                            CNPJ
                            {errors.cnpj && (
                                <span style={{ color: "red", fontSize: "1rem", paddingLeft: "8rem" }}>{errors.cnpj}</span>
                            )}
                        </Input>
