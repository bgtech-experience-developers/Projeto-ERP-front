    ...
    >
      <Form title="Cadastrar Cliente" width="87.8rem">
        ...
        <Card title="Contato Comercial">
          <FormsField variant="file" align="flex-end">
            <FormsField>
              <Input id="nomeComercial" height="4.8rem">
                Nome
              </Input>
              <Input id="emailComercial" height="4.8rem" type="email">
                Email
              </Input>
            </FormsField>
            <File text="Adicionar foto" />
          ...
          <FormsField variant="double">
            <Input id="telefoneComercial" height="4.8rem">
              Telefone
            </Input>
            <Input id="celularComercial" height="4.8rem">
              Celular
            </Input>
          </FormsField>

          <FormsField variant="double">
            <Input id="rgComercial" height="4.8rem">
              RG
            </Input>
            <Input id="cpfComercial" height="4.8rem">
              CPF
            </Input>
          </FormsField>
        </Card>
